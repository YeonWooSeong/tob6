	...
	mainPage : function(bookId, userid) {
			$.getJSON(context + '/book/Book_main/'+bookId ,function(data){
				var bookPage = '<div class="contents" >'
					...
					+'<span style="padding-left: 30px;"><input type="image" src="'+context+'/resources/images/btn_bag2.png" onclick="Cart.putInCart('+'\''+userid+'\''+','+'\''+data.bookId+'\''+')"></span>'
					+'<input type="image" src="'+context+'/resources/images/btn_buy2.png" onclick="Cart.putInPurchase('+'\''+userid+'\''+','+'\''+data.bookId+'\''+','+'\''+data.bookPrice+'\''+')" >'
